...
class SMTPTransport:
    ...
    async def send(self, message: MIMEMultipart, *, sender: Email, recipient: Email) -> None:
        ...
        try:
            ...
            raise EmailSendFailedException(self.messages.SMTP_CONNECTION_ERROR) from e
        except aiosmtplib.SMTPAuthenticationError as e:
            raise EmailSendFailedException(self.messages.SMTP_AUTHENTICATION_ERROR) from e
        except aiosmtplib.SMTPException as e:
            raise EmailSendFailedException(self.messages.SMTP_SEND_ERROR) from e
        except Exception as e:
            raise EmailSendFailedException(self.messages.SMTP_UNEXPECTED_ERROR) from e
