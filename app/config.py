...
VERIFICATION_CODE_REQUEST_COOLDOWN_SECONDS: int = int(os.getenv("VERIFICATION_CODE_REQUEST_COOLDOWN_SECONDS", "60"))
...
JWT_ANON_TOKEN_EXPIRE_MINUTES: int = int(os.getenv("JWT_ANON_TOKEN_EXPIRE_MINUTES", "60"))
