...
from app.services.auth.exceptions import UserNotFoundException, UsernameAlreadyExistsException
from app.services.user.use_cases.update_username import UpdateUsernameService


class TestUpdateUsernameService(TestCase):
    def setUp(self) -> None:
        self.logger = Mock()
    ...
    def test_exec_updates_username(self):
        ...
        try:
            ...
            async def _test():
                ...
                self.assertEqual(refreshed.username, "new_username")
